package com.example.membuat_petak
...
import com.example.membuat_petak.Data.DataSource
import com.example.membuat_petak.Model.Topic
import com.example.membuat_petak.ui.theme.Membuat_petakTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Membuat_petakTheme {// Menerapkan tema Grid2
                Surface(
                    modifier = Modifier
...
@Composable
fun ValueCard(value: Topic, modifier: Modifier = Modifier) {
    Card {
        Row {
            Box {
...
@Composable
fun ValuePreview() {
    Membuat_petakTheme { // Menerapkan tema saat preview
        val value = Topic(R.string.film, 321, R.drawable.film) // Contoh data untuk preview
        Column (
